// Web Serial API shim over node `serialport`, so esptool-js's Transport (which
// targets navigator.serial devices) can drive a COM port from Electron's main
// process. Validated against real hardware (ESP32-PICO-D4 / CH9102).
...
export class NodeWebSerialPort {
  ...
  // esptool-js's flushOutput closes the writer; recreate so the device stays
